...
def run(ckpt, model_type, dynamic, soft, eval, noisy):
    ...
    save_dir = 'data/output/' + model_type + '/'
    ...
    with open(os.getcwd() + '/data/output/' + model_type + '/' + model_type + '_eval.pkl', 'wb') as f:
    ...
    with open(os.getcwd() + '/data/output/' + model_type + '/' + model_type + '_policy_eval.pkl', 'wb') as f:
        pkl.dump(eval_data, f)
