...
def run(ckpt, model_type, dynamic, soft, transfer, noisy, eval):
    ...
    save_dir = 'data/output/' + model_type + '/simulation3/'
    ...
    cost = [env.cost]
    ammonia_lefts = [env.ammonia_left]
    ...
    for i in range(24*14):
        ...
        ammonia_lefts.append(env.ammonia_left)
    ...
    eval_data['Ammonia Left'] = ammonia_lefts

    with open(os.getcwd() + '/data/output/' + model_type + '/simulation3/' + model_type + '_eval.pkl', 'wb') as f:
