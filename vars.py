...
ETA = 0.90
INITIAL_STORAGE = 5000000*0 # Set here what is initially stored inside of the battery
...
V_TANK = 133*11                     # (m^3) volume of the tank
Nt = 11                          # number of tanks to be charged
